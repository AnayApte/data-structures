...
public class Driveway
{
    ...
    */
    public void add(int licensePlate)
    {
        ...
        driveway.push(Integer.valueOf(licensePlate));       
    }
    ...
    */
    ...
    {
        // Complete this method
        Integer license = driveway.pop();
        while(license != licensePlate)
        {
          street.push(license);
